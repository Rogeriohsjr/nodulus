...
**Status:** accepted locally on Windows. **Prerequisite:** 02-request-intake. **Method:** TDD.
...
- [x] NODE-001 acceptance verified and evidence recorded.
...
- [x] NODE-002 acceptance verified and evidence recorded.
...
- [x] NODE-003 acceptance verified and evidence recorded.
...
- [x] NODE-004 acceptance verified and evidence recorded.
...
- [x] NODE-005 acceptance verified and evidence recorded.
...
- [x] NODE-006 acceptance verified and evidence recorded.
...
- [x] NODE variants exercise real Ajv and real validation processes.
- [x] No rejected output enters accepted artifacts.
- [x] Persisted state and machine output agree for all three outcomes.
