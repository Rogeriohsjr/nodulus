...
**Status:** accepted locally on Windows. **Prerequisite:** 05-clarification-resume. **Method:** TDD.
...
- [x] SAFE-001 acceptance verified and evidence recorded.
...
- [x] SAFE-002 acceptance verified and evidence recorded.
...
- [x] SAFE-003 acceptance verified and evidence recorded.
...
- [x] SAFE-004 acceptance verified and evidence recorded.
...
- [x] SAFE-005 acceptance verified and evidence recorded.
...
- [x] SAFE-006 acceptance verified and evidence recorded.
...
- [x] Prove attempt limits and no full-action replay through captured requests.
- [x] Execute real subprocess cancellation and locking tests.
- [x] Separate known usage from estimates; record absence of live cost accuracy proof.
...
Stale locks are preserved and return `RUN_RECOVERY_REQUIRED`; v1 never removes them automatically. Inspect status and saved attempts to reconcile possible side effects before manual recovery or starting a new run. A live owner returns `RUN_LOCKED`.
