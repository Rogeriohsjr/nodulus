...
Status: folders 00 through 08 accepted, with hosted Windows/macOS/Linux validation. Folder 09 CI and local release-policy checks are implemented; actual publication and registry upgrade are deferred at the user's request. See folder 09 evidence for the final CI checkpoint.
