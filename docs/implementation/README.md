...
Status: folders 00 through 08 accepted locally on Windows. Hosted cross-platform verification belongs to slice 09.
...
Foundation was implemented using $nodulus-delivery-validation and accepted locally on Windows. The subsequent Luna-builder/Sol-reviewer pass completed INIT-002 through INIT-004. Folders 02 through 08 are also accepted locally; folder 09 is next. Provider adapters have fixture proof; live-provider checks remain unverified.
